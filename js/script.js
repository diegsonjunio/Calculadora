...
//Objeto que registra os valores e funções do cáculo
let calculo = {
    valorSalvo: null,
    funcaoParaCalcular: null,
};

//Ao carregar a página, atribui eventos aos botões por meio de seus identificadores(ids)
...
function atribuirEventos() {
    ...
    //Atrubiu eventos aos botões de operadores, ponto e resultado
...
function inserirNumero() {
    //Se o valor for um número, substitui pelo valor do conteúdo do botão
...
//Limpa o visor e os dados do cáculo
